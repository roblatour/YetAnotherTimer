...
I originally created this app for my own personal use - using it at the gym to count down rest periods between reps.  However, after it was done, I thought it would be a good idea to make a few enhancements so it could be shared - for example, adding in support for additional languages.
